...
import com.ctrlcreate.commlink.service.MyPageService;
...
public class MyPageController {
    ...
    public ResponseEntity<ApiResponse<Profile>> getMyPageData() {
        ApiResponse<Profile> apiResponse = new ApiResponse<>();
        apiResponse.setRequestId(IDUtil.generateRequestId());

        try {
            apiResponse.setData(myPageService.getUserDetails());
